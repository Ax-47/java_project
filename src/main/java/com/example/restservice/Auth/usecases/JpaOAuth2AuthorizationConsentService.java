...
import com.example.restservice.Auth.repositories.AuthorizationConsentRepository;
...
public class JpaOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
  ...
  private OAuth2AuthorizationConsent toObject(AuthorizationConsentModel authorizationConsent) {
  ...
  private AuthorizationConsentModel toEntity(OAuth2AuthorizationConsent authorizationConsent) {
    AuthorizationConsentModel entity = new AuthorizationConsentModel();
