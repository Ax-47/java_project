...
import com.example.restservice.Auth.repositories.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
  ...
  public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
    ...
    Optional<AuthorizationModel> result;
    if (tokenType == null) {
  ...
  private OAuth2Authorization toObject(AuthorizationModel entity) {
  ...
  private AuthorizationModel toEntity(OAuth2Authorization authorization) {
    AuthorizationModel entity = new AuthorizationModel();
