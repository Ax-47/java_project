...
public class RefreshTokenUsecase {
  ...
  public RefreshTokenUsecase(DatabaseRefreshTokenRepository databaseRefreshTokenRepository,
  ...
  public TokenResponseDTO execute(String bearer) {
    ...
    RefreshToken token = databaseRefreshTokenRepository
    ...
    User user = databaseUserRepository.findUserByUserId(token.getUserId())
        .orElseThrow(() -> new UnauthorizedException("Invalid refresh token"));
    ...
    databaseRefreshTokenRepository
        .revokeRefreshToken(token.getId(), user.getId());
